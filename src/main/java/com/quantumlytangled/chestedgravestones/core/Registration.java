...
public final class Registration {
    ...
    public void preInitialize(FMLPreInitializationEvent event) {
        ...
        ChestedGravestonesConfig.onFMLpreInitialization(event.getModConfigurationDirectory().getAbsolutePath());
    ...
    public void registerBlocks(final RegistryEvent.Register<Block> event) {
        ...
        GameRegistry.registerTileEntity(TileDeathChest.class, new ResourceLocation(ChestedGravestones.MODID, "death_chest"));
    }
    ...
    public void onPlayerDeath(@Nonnull LivingDeathEvent event) {
        ...
        if (!ChestedGravestonesConfig.IGNORE_KEEP_INVENTORY && playerEntity.world.getGameRules().getBoolean("keepInventory")) return;
