...
public class CommandRestore extends CommandBase {
  ...
  public String getUsage(@Nonnull final ICommandSender commandSender) {
    return "/cgrestore <identifier>: restore an online player's inventory\n/cgrestore <playerName> <identifier>: restore an inventory to another online player";
  }
  ...
  public void execute(@Nonnull final MinecraftServer server, @Nonnull final ICommandSender commandSender, @Nonnull final String[] args) {
    ...
    final ITextComponent textSender = new TextComponentTranslation("chestedgravestones.command.restored_sender", entityPlayer.getDisplayName());
    ...
    if (commandSender != entityPlayer) {
      final ITextComponent textTarget = new TextComponentTranslation("chestedgravestones.command.restored_target");
