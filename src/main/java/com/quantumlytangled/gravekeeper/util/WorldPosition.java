...
public class WorldPosition {
  ...
  public WorldPosition(final int dimensionId, @Nonnull final String worldName,
  ...
  public World getWorld() {
    if (world == null) {
      ...
      if (world == null) {
        GraveKeeper.logger
            .warn(String.format("Failed to load DIM%d (%s), defaulting to the overworld",
  ...
  public WorldPosition(@Nonnull final NBTTagCompound tagCompound) {
    ...
    world = null;
    blockPos = new BlockPos(tagCompound.getInteger("x"), tagCompound.getInteger("y"),
