...
public class GraveKeeperConfig {
  ...
  public static String[] COMPATIBILITY_ORDER = new String[]{
      ...
      "aether_legacy", "baubles", "cosmeticarmorreworked", "galacticraftcore", "techguns",
      "travelersbackpack"
  };
  ...
  public static void loadConfig(final File file) {
    ...
    CHARM_ARMOR_HELD_NAMES = config
        .get("charm", "charm_armor_held_names", CHARM_ARMOR_HELD_NAMES,
            String.join("\n", new String[]{
    ...
    CHARM_ARMOR_HOTBAR_NAMES = config
        .get("charm", "charm_armor_hotbar_names", CHARM_ARMOR_HOTBAR_NAMES,
            String.join("\n", new String[]{
    ...
    MOVE_SOULBOUND_ITEMS_TO_MAIN_INVENTORY = config
        .get("soulbound", "move_soulbound_items_to_main_inventory",
            MOVE_SOULBOUND_ITEMS_TO_MAIN_INVENTORY, String.join("\n", new String[]{
    ...
    USE_BED_OR_SPAWN_LOCATION_BELOW_Y = config
        .get("grave_location", "use_bed_or_spawn_location_below_y",
            USE_BED_OR_SPAWN_LOCATION_BELOW_Y, String.join("\n", new String[]{
